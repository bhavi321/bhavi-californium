...
//4th:----
// let authorId= await BooksModel.find({price:{$gte:50, $lte:100}}).select({ author_id:1,_id:0})
//    let authorName=[]
// for(let i=0;i<authorId.length;i++){
   
//    authorName.push(await AuthorModel.findOne(authorId[i]).select({author_name:1,_id:0}))
// }